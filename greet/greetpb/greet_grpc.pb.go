...
func (c *greetServiceClient) CalculateSum(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error) {
	out := new(SumResponse)
...
func (UnimplementedGreetServiceServer) CalculateSum(context.Context, *SumRequest) (*SumResponse, error) {
...
func _GreetService_CalculateSum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).CalculateSum(ctx, req.(*SumRequest))
	}
	return interceptor(ctx, in, info, handler)
}
